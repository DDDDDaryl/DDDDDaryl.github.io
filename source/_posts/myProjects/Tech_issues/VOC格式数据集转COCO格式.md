...
COCO全称Common Objects in COntext，是微软团队提供的一个可以用来进行图像识别的数据集，数据集分为**训练集、验证集、测试集**，数据集共有80个对象类别。
...
3. **categories字段**
   存储当前对象所属category的id，以及所属supercategory的name。
